  ...
  def self.イベント!(プレーヤー)
    ...
    when :e5
      ...
      [
        ...
        ["でもわたしはおぼえるのがにがてなので\nひみつをおてがみにかいておきます\n\nこれをみてちゃんとおもいだしてね", "[読む]"],
        ["ひとつめ\n\nわたしとテオくんのたからものは\nちずの[#{たからもののばしょ[0]},#{たからもののばしょ[1]}]にかくしたよ", "[読む]"],
        ["ふたつめ\n\nテオくんがおおさまになったら\nわたしをおよめさんにしてくれるんだって（＞＜）", "[読む]"],
        ["みっつめ\n\nそれでね！テオくんは\nたからものでキラキラのティアラをわたしにつくってくれるの♪", "[読む]"],
        ["さいご\n\nこのことは\nテオくんがおおさまになるまで\nだれにもいっちゃいけないの\n\nママにもみーちゃんにもね！", "[読み終える]"],
    ...
    when :fv
      ...
      rand(30).times { ふぁぼかせぎの恐怖 << [["[ふぁぼ！]", "[ふぁぼふぁぼ！]"].sample, "あはぁん・・"] }

      ふぁぼかせぎの恐怖 += [
        ["うなれ鉄拳！\n\nみーちゃんパーンチ！！", "げふぅ！！"],
        ["はぁはぁ・・・危なかった。\n\nダメな大人になっちゃうとこだったよ！マスター！", "うう、ごめんなさい"],
      ]
    ...
    when :終
      if プレーヤー.アイテム.include?(:Gem)
        [
          ...
          ["「天晴れである。今回の件は全て不問とし、今後については次期王に一任する。国王」\n\nだって。\nよく分かんないや", "そだね"],
